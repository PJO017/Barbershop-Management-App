...
public final class BarberViewBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton faveBt;
  ...
  private BarberViewBinding(@NonNull CardView rootView, @NonNull ImageButton faveBt,
  ...
  public static BarberViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.faveBt;
      ImageButton faveBt = ViewBindings.findChildViewById(rootView, id);
      if (faveBt == null) {
        break missingId;
      }
      ...
      return new BarberViewBinding((CardView) rootView, faveBt, nameView, ratingView, reviewBt);
    }
